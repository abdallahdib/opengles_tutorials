...
public:
     ...
     */
    CCameraEntity(const vec3f& position, const vec3f& target, float32 fov, const vec3f& up = vec3f(0, 0.f, 1.f), float32 zNear = 5.0f, float32 zFar = 10000.0f, float32 aspect = 1.5f);
